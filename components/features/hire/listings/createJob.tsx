                ...
                <div className="grid grid-cols-1 gap-6">
                  <div>
                    ...
                    <div className="relative">
                      <MDXEditor
                        className="min-h-[400px] border border-gray-200 rounded-[0.33em] overflow-y-auto"
                  ...
                  <div>
                    ...
                    {/* <div className="relative">
                      <MDXEditor
                        className="min-h-[400px] w-full border border-gray-200 rounded-[0.33em] overflow-y-auto"

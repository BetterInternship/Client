      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-lg md:text-lg font-normal mb-8">
            View student availability instantly on the platform. Book interviews in seconds.
          </p>
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-lg md:text-lg font-normal mb-4">
            Track, filter, and message, every applicant in one place. No spreadsheets needed. 
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image

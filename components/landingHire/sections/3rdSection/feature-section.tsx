    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-40 md:pb-60">
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 w-[2px] overflow-visible hidden md:block bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-200 dark:via-neutral-700 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]"
        >
          <motion.div
            style={{

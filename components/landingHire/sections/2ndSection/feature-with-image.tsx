...
export function Feature() {
  ...
  return (
    <div className="w-full py-20 border-t border-gray-900 overflow-hidden overflow-x-hidden h-[100vh] bg-neutral-950 text-white dark:bg-neutral-950 dark:text-white">
      <div className="flex flex-col lg:flex-row lg:items-center gap-20">
        <div className="flex gap-4 pl-0 lg:pl-20 flex-col flex-1">
          <div className="flex gap-2 mx-8 flex-col z-30">
            <h2 className="text-5xl tracking-tighter text-opacity-90 lg:max-w-2xl font-regular text-left text-gray-900 dark:text-white">
              Apply fast, <br />
              Get hired faster.
            </h2>

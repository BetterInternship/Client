        ...
        <div className="space-y-5 mt-6 [font-family:var(--font-paraluman-body)] text-sm leading-6 text-[#184d45]/86">
          <div className="space-y-2.5">
            ...
            <p className="[font-family:var(--font-paraluman-heading)] text-base font-bold tracking-[-0.025em] text-[#052338]">
              1. Marketing Proposal (Slide Deck / Presentation)
            </p>
            <AsteriskList
              items={[
                "Shows your marketing strategy for GIA.",
          ...
          <div className="space-y-2.5">
            ...
            <AsteriskList
              items={[
                "Face on camera throughout, with webcam visible.",
                "Introduce yourself, then present your proposal.",
                "Walk us through your strategy and thinking.",
          ...
          <form className="space-y-5" onSubmit={(e) => void onSubmit(e)}>
            <div className="grid gap-4">
              ...
              <div className="space-y-2 ">
                <div>
                  <label className="[font-family:var(--font-paraluman-heading)] text-sm font-bold tracking-[-0.02em] text-[#052338]">
                    Marketing Proposal Link{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <p className="[font-family:var(--font-paraluman-body)] text-xs text-[#052338]/42">
                    Share your slide deck, presentation, or any format that best
                    presents your marketing strategy.
                  </p>
                </div>
                <Input
                  required

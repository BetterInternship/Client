...
/**
 * Job page interactive body. Rendered by the server
 * page.tsx with the job already fetched (initialJob) so the details, share/
 * save/apply actions, and modals hydrate from real data instead of a
 * client-only fetch.
 */

  ...
  async rewrites() {
    ...
    routes.forEach(({ hosts, destination }) => {
      hosts.forEach((host) => {
        ...
        rewrites.push({
          source:
            "/:path((?!_next|fonts|BetterInternshipLogo|og|resume-loader|PrivacyPolicy|TermsConditions|Student_MOA|Company_Information|student-preview|hire-preview|miro-preview).*)*",
